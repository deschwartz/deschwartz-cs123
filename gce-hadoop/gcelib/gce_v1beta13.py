...
This generated code is for version v1beta13 of the API.
...
class MachineType(object):
  ...
  __slots__ = ['availableZone', 'description', 'ephemeralDisks', 'guestCpus', 'imageSpaceGb', 'maximumPersistentDisks', 'maximumPersistentDisksSizeGb', 'memoryMb', 'name', 'creationTimestamp', 'id', 'selfLink', '__gce', '__project']

  def __init__(self, availableZone=None, description=None, ephemeralDisks=None, guestCpus=None, imageSpaceGb=None, maximumPersistentDisks=None, maximumPersistentDisksSizeGb=None, memoryMb=None, name=None):
    self.__gce = None
    self.__project = None
...
class Project(object):
  ...
  def set_common_instance_metadata(self, items=None, blocking=True, gce=None):
    if gce is None: gce = self.__gce
    if gce is None: raise ValueError('Missing gce')
    return gce.set_common_instance_metadata(self, items, blocking)


class SerialPortOutput(object):
  """Generated class SerialPortOutput."""
  __slots__ = ['contents', 'selfLink']

  def __init__(self, contents=None, selfLink=None):
    self.contents = contents
    self.selfLink = selfLink

  def __str__(self):
    return '<SerialPortOutput instance at {0:#x}:\n{1}>'.format(
        id(self), json.dumps(SerialPortOutput._to_json(self), indent=2))

  __repr__ = __str__

  def to_json(self):
    return SerialPortOutput._to_json(self)
  ...
  def _from_json(resource, gce=None):
    if resource is None:
      return None
    kind = resource.get('kind')
    if kind != 'compute#serialPortOutput':
      raise ValueError('Cannot load SerialPortOutput from {0}.'.format(kind))

    return SerialPortOutput(
        resource.get('contents'),
        resource.get('selfLink'))

  @staticmethod
  def _to_json(value):
    result = {'kind': 'compute#serialPortOutput'}
    if isinstance(value, SerialPortOutput):
      if value.contents is not None:
        result['contents'] = value.contents
      if value.selfLink is not None:
        result['selfLink'] = value.selfLink
    elif isinstance(value, dict):
      temp = value.get('contents')
      if temp is not None:
...
class GoogleComputeEngine(gce_base.GoogleComputeEngineBase):
  ...
  VERSION = 'v1beta13'
  BASE_URL = 'https://www.googleapis.com/compute/v1beta13/projects/'
  ...
  __OBJECT_PARSERS = {
      ...
      'compute#serialPortOutput': SerialPortOutput._from_json,
  ...
  def add_access_config(self, instance=None, name=None, project=None, network_interface=None, natIP=None, blocking=True):
    ...
    return self._execute(gce_base.GoogleComputeEngineBase.API_REQUEST('POST', str(project) + '/instances/' + str(instance) + '/addAccessConfig', query_params, json.dumps(request)), blocking)
  ...
  def delete_access_config(self, instance=None, access_config=None, project=None, network_interface=None, blocking=True):
    ...
    if network_interface:
      query_params['network_interface'] = network_interface
    return self._execute(gce_base.GoogleComputeEngineBase.API_REQUEST('POST', str(project) + '/instances/' + str(instance) + '/deleteAccessConfig', query_params, None), blocking)
  ...
  def get_serial_port_output(self, instance=None, project=None):
    ...
    if not project:
      raise ValueError('project is a required parameter.')
    return self._execute(gce_base.GoogleComputeEngineBase.API_REQUEST('GET', str(project) + '/instances/' + str(instance) + '/serialPort', None, None), False)
  ...
  def __build_get_machine_type_request(self, machineType=None, project=None):
    ...
    if not project:
      raise ValueError('project is a required parameter.')
    return gce_base.GoogleComputeEngineBase.API_REQUEST('GET', str(project) + '/machineTypes/' + str(machineType), None, None)
  ...
  def list_machine_types(self, filter=None, project=None, maxResults=None, pageToken=None):
    ...
    if pageToken:
      query_params['pageToken'] = pageToken
    return self._execute(gce_base.GoogleComputeEngineBase.API_REQUEST('GET', str(project) + '/machineTypes', query_params, None), False)
  ...
  def all_machine_types(self, filter=None, project=None):
    ...
    if filter:
      query_params['filter'] = filter
    return self._generate('GET', str(project) + '/machineTypes', query_params)
  ...
  def set_common_instance_metadata(self, project=None, items=None, blocking=True):
    ...
    return self._execute(gce_base.GoogleComputeEngineBase.API_REQUEST('POST', str(project) + '/setCommonInstanceMetadata', None, json.dumps(request)), blocking)
